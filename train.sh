...
# python train.py -s ~/data/render/claudia/claudia_train --eval --exp_name render/claudia --motion_offset_flag --smpl_type smpl --actor_gender neutral --iterations 5000
